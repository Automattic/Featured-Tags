...
Tags: Featured Tags, post scheduler
...
3. Navigate to the queue page (Posts > Queue) to configure your Featured Tags settings.
...
= 0.2.1 =
* Initial release with core features for Featured Tags management.
